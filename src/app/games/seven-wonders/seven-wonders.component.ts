...
export class SevenWondersComponent {
    ...
    decks: [
      ...
      },
      {
        ...
        cards: [
          ...
          { tags: ['Green;Color', 'Compass'], minPlayers: 3 },
          { tags: ['Green;Color', 'Compass'], minPlayers: 4 },
          { tags: ['Green;Color', 'Gear'], minPlayers: 3 },
          { tags: ['Green;Color', 'Gear'], minPlayers: 5 },
          { tags: ['Green;Color', 'Tablet'], minPlayers: 3, count: 2 },
          { tags: ['Green;Color', 'Tablet'], minPlayers: 6 },
          { tags: ['Green;Color', 'Tablet'], minPlayers: 7 },
        ],
      },
      {
        id: 3,
        ...
        totalValidCards: (playerCount: number, validCards: Card[]) => {
          ...
          if (purpleCount === 0) {
            ...
            return [totalCount+playerCount + 2 - 10, totalCount+playerCount + 2 - 10]
          } else {
        ...
        cards: [
          ...
          { tags: ['Green;Color', 'Compass'], minPlayers: 3, count: 2 },
          { tags: ['Green;Color', 'Compass'], minPlayers: 6 },
          { tags: ['Green;Color', 'Compass'], minPlayers: 7 },
          { tags: ['Green;Color', 'Gear'], minPlayers: 3, count: 2 },
          { tags: ['Green;Color', 'Gear'], minPlayers: 5 },
          { tags: ['Green;Color', 'Gear'], minPlayers: 7 },
          { tags: ['Green;Color', 'Tablet'], minPlayers: 3 },
          { tags: ['Green;Color', 'Tablet'], minPlayers: 4 },
          ...
          {
            tags: ['Purple;Color', 'Gear', 'Compass', 'Tablet'],
            minPlayers: 3,
            probabilityFunc: this.purpleCardProbability,
          },
          {
  ...
  purpleCardProbability(playerCount: number): number {
